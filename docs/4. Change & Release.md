...
- Mindre än fem procent av testpromptar får returnera felmeddelande.
...
## 4.4 Change Enablement - Rollback Plan
...
1. Martin Lindqvist som Change Authority godkänner beslut om rollback.
...
5. Lina Nordin och samtliga medarbetare meddelas via e-post.
