...
|---|--------|-----|----------|-------------------|-------|
| 1 | **Tillgänglighet** | 99,0 % per månad | [Antagande: Synthetic monitoring via övervakningsdashboard] | Grunden för att tjänsten ska leverera nytta. Avbrott påverkar alla ~450 medarbetare | Anna Berg |
...
| 6 | **Kunskapsbasens aktualitet** | 100 % av artiklar har dokumenterad ägare och reviewdatum | [Antagande: Inventering i SharePoint eller motsvarande kunskapsbasverktyg (automatiserad påminnelse varje kvartal)] | Gammal kunskapsbas ger felaktiga svar och urholkar förtroendet | Karl Eek |
...
| 8 | **Leverantörsstatus – Lumeon** | Inga P1-incidenter utan kommunikation inom 30 min | Incidentlogg från Lumeon | LLM-tjänsten är otillgänglig – AI-svar kan inte genereras | Anna Berg |
